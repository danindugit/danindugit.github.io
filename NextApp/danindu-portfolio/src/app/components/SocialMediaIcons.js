export default function SocialMediaIcons() {
    return (
        <ul className="nav justify-content-center list-unstyled d-flex">
            <li>
                <a className="text-body-secondary" href="mailto:danindum@outlook.com">
            ...
            <li className="ms-5">
                <a className="text-body-secondary" href="https://github.com/danindugit" target="_blank">
            ...
            <li className="ms-5">
                <a className="text-body-secondary" href="https://www.linkedin.com/in/danindu-marasinghe-ab94051a6/" target="_blank">
            ...
            <li className="ms-5">
                <a className="text-body-secondary" href="https://www.facebook.com/profile.php?id=100010162722755" target="_blank">
